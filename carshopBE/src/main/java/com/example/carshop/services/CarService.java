...
public class CarService {
    ...
    @Transactional
    public CarDto updateCar(Long id, CarDto carDto, List<MultipartFile> newImages, String keepImageIdsParam) throws IOException {
    ...
    public List<CarDto> getLatestCars() {
        return carRepository.findTop12ByIsDraftFalseOrderByPriceDesc().stream()
                .map(this::toDto)
                .toList();
    }
